...
(define-public pari-gp
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0lsbra48dkp9k5n4k7kg0dvnp4f6mchbrb9z9cw7s04iqfcisr82"))))
    (build-system gnu-build-system)
  ...
  (package
    ...
    (arguments
     (list
      ...
      #:build-type "Release"
      ;; These tests fail for unknown reasons.
      #:test-exclude
      (string-append "("
                     (string-join '("packetmath_11"
                                    "packetmath_12"
                                    "basicstuff_8"
                                    "stable_norm_5"
                                    "stable_norm_6")
            ...
            (lambda* (#:key tests? (test-exclude "") #:allow-other-keys)
              (let* ((cores  (parallel-job-count))
                ...
                (when tests?
                  ...
                  (invoke "ctest" "-V" dash-j "-E" test-exclude))))))))
...
features, and more.")
    ;; Most of the code is MPLv2, with a few files under BSD-3 or other
    ;; MPLv2-compatible licenses.
    ;; See 'COPYING.README' for details.
    (license (list license:mpl2.0
                   license:bsd-3
                   (license:non-copyleft "file://COPYING.MINIPACK")
                   license:asl2.0))))
...
(define-public msolve
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1adxnl4y1dh13avsz2r51d52g9njgfav8s231mmg6bh4p3xjwm7c"))))
    (build-system gnu-build-system)
    (native-inputs (list autoconf automake libtool))
